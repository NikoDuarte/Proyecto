...
<body>  
   ...
   <div class="navbar">
       <a href="../app_estudiante.php">Regresa Inicio</a>
   ...
   <div class="row">
     ...
     ?>
       ...
       <br><br>
       Sede<input type="text" name="sede" id="sede" value="<?php echo $consulta ['sede'];?>" disabled>
       <br><br>
...
if (isset($_POST['actualizar']))
{
  ...
  $password = $_POST['password'];
    ...
    echo "$nombre,$apellido,$documento,$password";

    

  $sql = $con->query("UPDATE usuarios SET password = '$password' WHERE correo = '$correo'");
  if ($sql) {
    echo "<script type='text/javascript'>window.location='mi_perfil_est.php?correo=$_SESSION[username]';</script>";
  }else{
