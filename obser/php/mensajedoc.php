...
if($_POST['obser']==" " || $_POST['estudiante']==" " || $_POST['curso']==" "){
    echo "<script type='text/javascript'>
        alert('todos los camos son obligarorios');
    ...
    else
    {
        ...
        $contar =mysqli_num_rows($consulta);
            ...
            if ($contar != 0) {
                ...
                $sentencia="INSERT INTO observaciones (de,para,curso,tipo,fecha,observacion) values('".$_SESSION['documento']."','".$row['documento']."','$curso','$tipo',now(),'$observacion')"; 
